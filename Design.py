...
def mainDesign(master,self):
        ...
        self.master.title("CENTS - BANK")
        self.master.minsize(650,550)
        self.master.maxsize(650,550)
...
def userDesign(master,self,str = "USER ACCOUNT"):
        ...
        Label(self,text = str,fg = "blue",relief = RAISED,bg = "black",borderwidth = 10,height = 2,
              padx = 3,pady = 3,width = 68,font = "ALGERIAN").grid(columnspan=90)
...
def userMenu(master,self):
        ...
        self.mbar.add_command(label = "Return",command = self.Exit)
...
def adminMenu(master,self):
        ...
        self.option.add_command(label = "Exit",command = self.Exit)
        self.option.add_separator()
