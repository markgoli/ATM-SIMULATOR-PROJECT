...
class Bank(Frame):
    ...
    def main(self):
        ...
        Label(self,text = "WELCOME CENTS-BANK ATM OUTLET \n\n CONTINUE AS ?...",fg = "blue", state="normal",
              relief = RAISED,bg = "black",borderwidth = 2,height = 5,padx = 3,pady = 3,
              width = 80,font = "Calibri").grid()
        
        Button(self,text = "Enter As SysAdmin",bg = "pink",fg = "blue",width = 75,
               height = 2,command = self.AdminStart,activeforeground = "red").grid(sticky = W+S,pady = 20,padx = 5)
        
        Button(self,text = "Enter As Normal User",bg = "pink",fg = "blue",width = 75,
               height = 2,command = self.UserStart,activeforeground = "red").grid(sticky = W+S,padx = 5)
        
        Button(self,text = "QUIT MACHINE",bg = "pink",fg = "blue",width = 40,
               height = 2,command = self.Cancel,activeforeground = "red", justify=CENTER).grid(sticky = W+S,pady = 15,padx = 150)
    ...
    def UserStart(self):
        ...
        if self.chances>0:
            ...
            Label(self,text = "Acct. Name :",fg = "white",bg = "blue",width = 10,
                  justify = CENTER).grid(sticky = E+S+N+W,pady = 10,padx = 5)
            ...
            Label(self,text = " Pin.No. :",fg = "white",bg = "blue",width = 10,
                  justify = CENTER).grid(sticky = E+S+N+W,padx = 5)
            ...
            Checkbutton(self,text = "show password",variable = self.cVar,command = toggle,bg = "blue",
                        activebackground = "blue").grid(sticky = N+W+S+E,column = 1, pady = 10,padx = 5 )
            
            Button(self,text = "Log-In",command = self.NameCheck, justify=CENTER).grid()
        else:
    ...
    def UserOption(self):
        ...
        Button(self,text = "Deposit Cash",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.Deposit).grid(columnspan = 120)
        Button(self,text = "Withdraw Cash",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.Withdraw).grid(columnspan = 120)
        
        Button(self,text = "Balance Inquiry",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.balance).grid(columnspan = 120)
        Button(self,text = "Transfer Cash",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.Transfer).grid(columnspan = 120)
        
        Button(self,text = "Change Pin",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.ChangePin).grid(columnspan = 120)
        Button(self,text = "Delete Account",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.DelAccount).grid(columnspan = 120)
        
        Button(self,text = "Exit",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.Cancel).grid(columnspan = 120)
    ...
    def Withdraw(self):
        ...
        def AmountCheck():
            #function to check if amount is a multiple of #100
            try:
                amnt = int(self.amnt.get())
                if not amnt%100==0:
                    messagebox.showinfo("Error","Amount Should Be In Multiples Of Thousands!!.")
    ...
    def ChangePin(self):
        ...
        Label(self,text = "  Input New Pin :",fg = "white",bg = "blue",width = 15,
              justify = CENTER).grid(sticky = E+S+N+W,pady = 10,padx = 5)
    ...
    def AdminStart(self):
        ...
        Label(self,text = "SysAdmin Pin :",fg = "white",bg = "blue",width = 20,
              justify = CENTER).grid(sticky = E+S+N+W,pady = 5,padx = 5)
        self.e1 = Entry(self,bg = "pink",fg = "blue",width = 20,textvariable = self.adminPin,
                        exportselection = 0,show = "*")
        ...
        Checkbutton(self,text = "show pin",variable = self.cVar,command = toggle,bg = "blue",
                    activebackground = "blue").grid(sticky = N+W+S+E,column = 1, pady = 15,padx = 5)
        Button(self,text = "Log-In",command = self.AdminPinCheck, justify=CENTER).grid(pady = 15,padx = 5)
    ...
    def AdminPinCheck(self):
        ...
        if len(str(pin))==4:
            ...
            if acct.CheckPin():
                ...
                messagebox.showerror("INCORRECT PIN!","Invalid Admin Pin\nExiting Admin Mode !!")
                self.destroy()
                self.main()
        else:
            messagebox.showerror("INCORRECT PIN","Invalid Amin Pin\nExiting Admin Mode !!")
            self.destroy()
            self.main()
    ...
    def AdminOption(self):
        ...
        Button(self,text = "Exit",bg = "pink",fg = "blue",width = 40,height = 2,
               activeforeground = "red",command = self.Exit).grid(columnspan = 100,pady = 6)
    ...
    def register_new_user(self):
        """REGISTERS A NEW USER INTO THE BANK'S DATABASE WITH DEFAULT PASSWORD OF 0000"""
    ...
    def usersInfo(self):
        ...
        self.text = ScrolledText(self,width = 66,borderwidth = 5,relief = SUNKEN,height = 16,bg = "pink",fg = "blue") 
    ...
    def view_all_cash(self):
        ...
        self.text = ScrolledText(self,width = 66,borderwidth = 10,relief = SUNKEN,height = 16,bg = "pink",fg = "blue") 
        self.text.grid(pady = 5)
        Button(self,text = "OK",command = done,width=45,borderwidth = 5,relief = RAISED).grid()
